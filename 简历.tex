...
\research{操作系统实验}{2025 年秋季}{https://github.com/xiaoshouyichuai/OS}
\begin{itemize}
...
\vspace{0.5em}
\research{计算机体系结构实验与计算机组成原理实验}{2025 年秋季}{https://github.com/xiaoshouyichuai/CA}
\begin{itemize}
...
\vspace{0.5em}
\research{机器学习导论}{2025 年秋季}{https://github.com/xiaoshouyichuai/Kaggle--Plant-Seedlings-Classification}
\begin{itemize}
  \item 在 Kaggle 植物幼苗数据集上搭建 BasicCNN 基线，并评估 ResNet 与 Vision Transformer。
  \item 使用 AdamW、标签平滑、预训练和分阶段解冻，将验证准确率从 26\% 提升至 95\%。
\end{itemize}
